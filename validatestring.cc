...
DEFUN_DLD (validatestring, args, nargout, "-*- texinfo -*-\n\
      ...
      for (i = 0; i < nmatches; i++)
        {
          if (i != min_len_idx
                                            ...
                                            strarray(matches(i)), min_len))
            {
              ...
              error (("validatestring: " + errstr
                      + "allows multiple unique matches:\n" + non_match_str)
                         .c_str ());
            }
        }
...
%!error <DUMMY_TEST: 'xyz' does not> validatestring ("xyz", strarray,
"DUMMY_TEST")
%!error <DUMMY_TEST: DUMMY_VAR does> validatestring ("xyz", strarray,
"DUMMY_TEST", "DUMMY_VAR")
%!error <DUMMY_TEST: DUMMY_VAR \(argument #5\) does> validatestring ("xyz",
strarray, "DUMMY_TEST", "DUMMY_VAR", 5)
...
%!error <invalid number of character inputs> validatestring ("xyz", {"xyz"},
"3", "4", "5")
%!error <STR must be a character string> validatestring (1, {"xyz"}, "3", "4",
5)
%!error <STR must be a single row vector> validatestring ("xyz".', {"xyz"},
"3", "4", 5)
%!error <STRARRAY must be a cellstr> validatestring ("xyz", "xyz", "3", "4", 5)
%!error <FUNCNAME must be a single row vector> validatestring ("xyz", {"xyz"},
"33".', "4", 5)
%!error <VARNAME must be a single row vector> validatestring ("xyz", {"xyz"},
"3", "44".', 5)
